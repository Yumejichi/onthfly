...
const App = () => {
  ...
  const API_URL = import.meta.env.PROD ? 'https://server-0ml7.onrender.com' : '/api'
  ...
  let element = useRoutes([
    ...
    {
      path: '/destinations',
      element: user && user.id ? <ReadDestinations data={destinations} /> : <Login api_url={API_URL} />
    },
    {
      path: '/trip/get/:id',
    ...
    },
    {
      ...
      element: user && user.id ? <AddToTrip user={user} data={trips} api_url={API_URL} /> : <Login api_url={API_URL} />
    },
    {
      path: '/users/add/:trip_id',
      element: user && user.id ? <AddUserToTrip user={user} data={trips} api_url={API_URL} /> : <Login api_url={API_URL} />
    }
  ])
